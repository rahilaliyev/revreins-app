...
export { CalendarLineIcon } from './calendarLine';
...
export { More2FillIcon } from './more2Fill';
...
export { SendPlaneLineIcon } from './sendPlaneLine';
...
export { UserFillIcon } from './userFill';
export { UserLineIcon } from './userLine';
